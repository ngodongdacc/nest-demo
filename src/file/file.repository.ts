...
export class FileRepository extends Repository<File> {
  public async list(param: GetListFile): Promise<ResponseData> {
  ...
  public async getFile(param: { Key: string }): Promise<any> {
    const bucketParams = {
      Bucket: Var_globlal_AWS.bucket,
      ...param,
    };
  ...
  public async getUrlFile(param: { Key: string }): Promise<string> {
    const bucketParams = {
      Bucket: Var_globlal_AWS.bucket,
      ...param,
    };
  ...
  async uploadFile(param: { Key: string }) {
