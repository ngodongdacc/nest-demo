...
export class FileController {
    ...
    public async dowloadFile(
        ...
        const request = https.get("https://dongngo-test.s3.ap-southeast-1.amazonaws.com/dung_xa_em.mp4?AWSAccessKeyId=AKIAYNSHB5H4JFEIKGFS&Expires=1652689013&Signature=402An6NID6W5oRBiKKpK6alkzDc%3D", function(response) {
           response.pipe(file);
